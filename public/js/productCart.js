...
async function pagar() {
  ...
  const invoiceFetch = await fetch('/api/product/cart', {
    method: 'POST',
                        ...
                        <div class="col-lg-7 col-sm-11 col-11 mx-auto px-4 mt-2 mt-lg-5">
                            <div class="row mb-lg-4 me-lg-3 ms-lg-3">
                                ...
                                <div class="col-lg-4 col-11 mt-4 py=4">
                                    <div class="justify-content-end align-items-center mt-lg-4 mb-lg-2 mb-4">
                                        ...
                                        <button class="agregar-cantidad" id="agregar-cantidad" onclick=agergarCantidad('${
                                          row.id
                                        }')>+</button>
                                        <span>${row.cantidad}</span>
                                        
                                        <button class="agregar-cantidad" id="disminuir-cantidad" onclick=disminuirCantidad('${
                                          row.id
                                        }')>-</button>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-lg-4 py-lg-3">
                                <div class="col-lg-9 col-6 d-flex justify-content-between">
                                    <button type="submit" class="btn eliminar_editar mt-2 text-center" onclick=eliminarProducto('${
                                      row.id
                                ...
                                <div class="col-lg-3 col-6 d-flex justify-content-end">
                                    <p class="mt-3 text-center" id="price_money">$<span id="itemval">${
                                      row.cantidad * row.valor
                                    }</span></p>
                                </div>
