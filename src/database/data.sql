...
INSERT INTO `grupos-productos`(id, nombre, detalle, `categorias-fk`, ingredientes, `marcas-fk`, `created-at`, `updated-at`) VALUES
(DEFAULT, 'Sesaderma Oil', 'Duis at velit eu est congue elementum. In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo. Aliquam quis turpis eget elit sodales scelerisque.', 7, NULL, 1, NOW(), NOW());
...
(DEFAULT, 'Serum contorno de ojos', 'Este poderoso sérum contiene una rejuvenecedora mezcla de péptidos, niacinamida, coenzima Q10 y extracto de pepino, que estimula la producción de colágeno y elastina, al tiempo que reduce la profundidad de las arrugas y las manchas de la edad. En solo unos pocos días tendrás una mirada más fresca, descansada y juvenil. ¡No vas a poder creer lo que están viendo tus ojos!
 ...
 Ideal para todo tipo de piel.', 1, 'Péptidos: moléculas que surgen de la unión de dos o más aminoácidos. Los tetrapéptidos ayudan a reducir la apariencia de las arrugas y a promover una mayor elasticidad en la piel.
...
INSERT INTO `grupos-productos`(id, nombre, detalle, `categorias-fk`, ingredientes, `marcas-fk`, `created-at`, `updated-at`) VALUES
(DEFAULT, 'Loción tónica purificante', 'Loción tónica purificante para pieles grasas o mixtas que ayuda a restaurar el equilibrio de la microbiota cutánea gracias al revolucionario Microbiote complex , a la vez que reequilibra el tipo de piel, dejándola saludable y bella.', 2, 'ingredientes marinos y polifenoles de azafrán', 4, NOW(), NOW());

INSERT INTO `grupos-productos`(id, nombre, detalle, `categorias-fk`, ingredientes, `marcas-fk`, `created-at`, `updated-at`) VALUES
(DEFAULT, 'Exfoliante facial en gel', 'Gel exfoliante facial activo para todo tipo de pieles, basado en las propiedades exfoliantes de la vitamina C y la vitamina B3.', 7, 'Ingredientes principales: niacinamida, vitamina C, vitamina E, proteínas de arroz hidrolizadas, aceite de camelia japonesa, vitamina B5, B6.', 6, NOW(), NOW());
